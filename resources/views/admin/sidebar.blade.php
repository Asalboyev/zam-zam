    ...
    <aside id="sidebar-wrapper">
      ...
      <ul class="sidebar-menu">
        ...
        <li class="dropdown ">
          ...
          <li class="dropdown ">
            <a href="{{ route('admin.orders.index') }}" class="nav-link"><i data-feather="shopping-cart"></i><span> Buyrtma yaratish </span></a>
          ...
          {{--         <li class="dropdown ">--}}
{{--            <a href="{{ route('admin.products.index') }}" class="nav-link"><i data-feather="monitor"></i><span>Posts</span></a>--}}
{{--         </li>--}}
{{--         <li class="dropdown ">--}}
{{--            <a href="{{ route('admin.daily_meal.index') }}" class="nav-link"><i data-feather="monitor"></i><span>Tags</span></a>--}}
{{--         </li>--}}
{{--         <li class="dropdown ">--}}
{{--            <a href="{{ route('admin.delivers.index') }}" class="nav-link"><i data-feather="monitor"></i><span>Advertising</span></a>--}}
{{--         </li>--}}
      </ul>
    </aside>
  </div>
